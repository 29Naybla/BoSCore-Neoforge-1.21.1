...
public class BoSRecipeSerializers {
    ...
    public static final Supplier<RecipeSerializer<?>> BAKING_SHAPELESS = RECIPE_SERIALIZERS.register("baking_shapeless",BakingShapelessRecipe.Serializer::new);

    public static final Supplier<RecipeSerializer<?>> BAKING_SHAPED = RECIPE_SERIALIZERS.register("baking_shaped", BakingShapedRecipe.Serializer::new);
